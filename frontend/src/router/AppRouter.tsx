    ...
    <AnimatePresence mode="wait" initial={false}>
      <Routes location={location} key={location.pathname}>
        ...
        <Route element={<PublicLayout />}>
          ...
          <Route
            path="/connexion"
            element={isLoading ? null : isAuthenticated ? <Navigate to="/profil" replace /> : <LoginPage />}
          />
          <Route
            path="/inscription"
            element={isLoading ? null : isAuthenticated ? <Navigate to="/profil" replace /> : <RegisterPage />}
          />
