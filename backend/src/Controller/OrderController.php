...
class OrderController extends AbstractController
{
    ...
    // LIST ORDERS OF USER
    #[OA\Response(response: 200, description: 'Commandes de l\'utilisateur')]
    ...
    // GET ORDER BY ID
    #[OA\Response(response: 200, description: 'Détail de la commande')]
    ...
    #[OA\Tag(name: 'Admin')]
    #[OA\Response(response: 200, description: 'Statut de la commande mis à jour')]
