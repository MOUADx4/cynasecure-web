...
{
    #[OA\Response(response: 200, description: 'Code promo valide')]
    #[OA\Response(response: 400, description: 'Code invalide ou conditions non remplies')]
    #[OA\RequestBody(content: new OA\JsonContent(properties: [new OA\Property(property: 'code', type: 'string'), new OA\Property(property: 'total', type: 'number')]))]
    ...
    #[OA\Response(response: 200, description: 'Code promo retiré')]
