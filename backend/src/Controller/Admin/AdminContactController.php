...
{
    #[OA\Response(response: 200, description: 'Liste paginée des messages de contact')]
    ...
    #[OA\Response(response: 200, description: 'Statut du message mis à jour')]
    ...
    #[OA\Response(response: 200, description: 'Réponse envoyée au message de contact')]
    ...
    #[OA\Response(response: 200, description: 'Liste paginée des conversations chatbot')]
    ...
    #[OA\Response(response: 200, description: 'Détail d\'une conversation chatbot')]
