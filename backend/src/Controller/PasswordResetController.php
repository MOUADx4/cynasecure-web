...
class PasswordResetController extends AbstractController
{
    ...
    #[OA\Response(response: 200, description: 'Lien de réinitialisation envoyé (réponse générique)')]
    #[OA\RequestBody(content: new OA\JsonContent(properties: [new OA\Property(property: 'email', type: 'string', format: 'email')]))]
    ...
    #[OA\RequestBody(content: new OA\JsonContent(properties: [new OA\Property(property: 'token', type: 'string'), new OA\Property(property: 'newPassword', type: 'string')]))]
