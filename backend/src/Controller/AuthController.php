...
class AuthController extends AbstractController
{
    ...
    public function register(
        ...
        $displayName = trim($data['displayName'] ?? ($firstName || $lastName ? "$firstName $lastName" : ''));
    ...
    #[OA\Response(response: 200, description: 'Email vérifié')]
    ...
    #[OA\Response(response: 200, description: 'Email renvoyé')]
    ...
    #[OA\Tag(name: 'Auth')]
    #[OA\Response(response: 204, description: 'Déconnexion')]
