...
class PayPalService
{
    ...
    public function createOrder(float $total, array $lineItems, ?string $returnUrl = null, ?string $cancelUrl = null): array
    {
        ...
        if ($returnUrl || $cancelUrl) {
            $payload['application_context'] = [
                'brand_name'  => 'CynaSecure',
                'user_action' => 'PAY_NOW',
                'return_url'  => $returnUrl ?? 'https://cynasecure.com/checkout/success',
                'cancel_url'  => $cancelUrl ?? 'https://cynasecure.com/checkout/cancel',
            ];
        }
