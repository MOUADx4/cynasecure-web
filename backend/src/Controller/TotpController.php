...
{
    #[OA\Response(response: 200, description: 'Statut 2FA de l\'utilisateur')]
    ...
    #[OA\Response(response: 200, description: 'Secret TOTP et contenu QR code')]
    ...
    #[OA\Response(response: 200, description: '2FA activé')]
    #[OA\RequestBody(content: new OA\JsonContent(properties: [new OA\Property(property: 'code', type: 'string')]))]
    ...
    #[OA\Response(response: 200, description: '2FA désactivé')]
    #[OA\RequestBody(content: new OA\JsonContent(properties: [new OA\Property(property: 'password', type: 'string'), new OA\Property(property: 'code', type: 'string')]))]
