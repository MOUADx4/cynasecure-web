...
{
    #[OA\Tag(name: 'Catalog')]
    #[OA\Parameter(name: 'type', in: 'query', required: false, schema: new OA\Schema(type: 'string', enum: ['saas', 'one_shot']))]
    #[OA\Response(response: 200, description: 'Liste des services', content: new OA\JsonContent(type: 'array', items: new OA\Items(ref: new Model(type: Service::class))))]
    ...
    #[OA\Parameter(name: 'categories', in: 'query', required: false, schema: new OA\Schema(type: 'string'))]
    #[OA\Parameter(name: 'type', in: 'query', required: false, schema: new OA\Schema(type: 'string', enum: ['all', 'saas', 'one_shot']))]
    #[OA\Parameter(name: 'sort', in: 'query', required: false, schema: new OA\Schema(type: 'string', enum: ['relevance', 'price_asc', 'price_desc', 'newest']))]
    #[OA\Parameter(name: 'priceMin', in: 'query', required: false, schema: new OA\Schema(type: 'number'))]
    #[OA\Parameter(name: 'priceMax', in: 'query', required: false, schema: new OA\Schema(type: 'number'))]
    #[OA\Parameter(name: 'onlyAvailable', in: 'query', required: false, schema: new OA\Schema(type: 'boolean'))]
    ...
    #[OA\Tag(name: 'Catalog')]
    #[OA\Response(response: 200, description: 'Détail du service', content: new OA\JsonContent(ref: new Model(type: Service::class)))]
    ...
    #[OA\Response(response: 200, description: 'Services similaires')]
