...
{
    #[OA\Response(response: 200, description: 'Liste des messages de l\'utilisateur')]
    ...
    #[OA\Response(response: 200, description: 'Nombre de réponses non lues')]
    ...
    #[OA\Response(response: 200, description: 'Réponses marquées comme lues')]
