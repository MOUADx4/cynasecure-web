...
{
    #[OA\Response(response: 200, description: 'Liste paginée des codes promo')]
    ...
    #[OA\Response(response: 201, description: 'Code promo créé')]
    ...
    #[OA\Response(response: 200, description: 'Code promo aléatoire généré')]
    ...
    #[OA\Response(response: 200, description: 'Détail d\'un code promo')]
    ...
    #[OA\Response(response: 200, description: 'Code promo mis à jour')]
    ...
    #[OA\Response(response: 200, description: 'Code promo supprimé')]
